 ...
 *
 * @mixin \mPhpMaster\LaravelTraitsHas\Interfaces\IHasAttributesWithString
...
trait THasAttributesWithString
{
    ...
    {
        return collect(static::getAllowedStrings())->search(fn ($v) => $v == $value);
    }
    ...
    public static function getStringInfoFromAttributeName(string $attribute_name): array
    {
        return [
            ...
            'string_value' => ($string_value = collect(static::getAllowedStrings())->get($string_name, fn()=>value(''))),
